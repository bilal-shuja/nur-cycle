...
const CycleChart = () => {
  ...
  const CustomTooltip = ({ active, payload, label }: any) => {
    if (active && payload && payload.length) {
      ...
      return (
        ...
        //     <p className="font-semibold text-purple-800">{`Date: ${label}`}</p>
        //   </div>
        //   <p className="text-sm text-gray-600">{`Cycle Day: ${data.day}`}</p>
        //   <p className="text-sm text-gray-600">{`Phase: ${data.phase}`}</p>
        //   <p className="text-sm text-gray-600">{`Cycle Length: ${data.length} days`}</p>
        //   <p className="text-sm text-gray-600">{`Energy Level: ${data.energy}/10`}</p>
        // </div>
        <>
  ...
  return (
    ...
    <>
        {/* <Card className="bg-gradient-to-br from-purple-50 via-white to-pink-50 border border-purple-200 relative overflow-hidden">
      ...
      <CardContent className="relative z-10">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 text-sm bg-white/60 backdrop-blur-sm p-4 rounded-lg border border-purple-100">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-700 font-semibold">Cycle Length Journey</span>
              <span className="text-xl">🌸</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-1 bg-amber-400 rounded-full"></div>
              <span className="text-gray-700 font-semibold">Energy Levels</span>
              <span className="text-xl">⚡</span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-8 h-0.5 bg-pink-500" style={{ borderStyle: 'dashed' }}></div>
            <span className="text-gray-700 font-semibold">Average (28 days)</span>
            <span className="text-xl">📊</span>
          </div>
        </div>
      </CardContent>
  ...
  <CardContent className="relative z-10">
    ...
    <div className="mt-6 grid grid-cols-1 gap-4 text-sm bg-white/60 dark:bg-slate-800 backdrop-blur-sm p-4 rounded-lg border border-purple-100 dark:border-slate-700">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-6 h-6 bg-gradient-to-r from-purple-600 via-pink-500 to-purple-500 rounded-full shadow-sm"></div>
          <span className="text-gray-700 dark:text-white font-semibold">Cycle Length Journey</span>
          <span className="text-xl">🌸</span>
        </div>
        <div className="flex items-center gap-3">
          <div className="w-6 h-1 bg-amber-400 rounded-full"></div>
          <span className="text-gray-700 dark:text-white font-semibold">Energy Levels</span>
          <span className="text-xl">⚡</span>
        </div>
      </div>
      <div className="flex items-center gap-3">
        <div className="w-8 h-0.5 bg-pink-500" style={{ borderStyle: 'dashed' }}></div>
        <span className="text-gray-700 dark:text-white font-semibold">Average (28 days)</span>
        <span className="text-xl">📊</span>
      </div>
    </div>
  </CardContent>
