...
const GraphsReports = ({ onBack }: GraphsReportsProps) => {
  ...
  const symptomTrendData = [
    { date: `${getLocalizedText('week')} 1`, cramping: 2, mood: 3, fatigue: 1, bloating: 2 },
    { date: `${getLocalizedText('week')} 2`, cramping: 1, mood: 2, fatigue: 2, bloating: 1 },
    { date: `${getLocalizedText('week')} 3`, cramping: 4, mood: 4, fatigue: 3, bloating: 3 },
    { date: `${getLocalizedText('week')} 4`, cramping: 3, mood: 3, fatigue: 2, bloating: 2 },
  ];
  ...
  const fertilityData = [
    { phase: getLocalizedText('menstrual'), days: 5, probability: 5 },
    { phase: getLocalizedText('follicular'), days: 7, probability: 15 },
    { phase: getLocalizedText('ovulation'), days: 3, probability: 85 },
    { phase: getLocalizedText('luteal'), days: 13, probability: 25 },
  ];

  const moodPatternData = [
    { day: `${getLocalizedText('day')} 1`, mood: 2, energy: 3 },
    { day: `${getLocalizedText('day')} 7`, mood: 4, energy: 5 },
    { day: `${getLocalizedText('day')} 14`, mood: 5, energy: 4 },
    { day: `${getLocalizedText('day')} 21`, mood: 3, energy: 3 },
    { day: `${getLocalizedText('day')} 28`, mood: 2, energy: 2 },
  ];
      ...
      <div className={`relative overflow-hidden card-3d shadow-sm border-b`}>
        ...
        <div className="relative z-10 flex items-center justify-between p-4">
          ...
          <h1 className={`text-lg font-semibold ${settings.darkMode ? 'text-white' : 'text-gray-900'}`}>
            📊 {getLocalizedText('graphs.and.reports')}
          </h1>
        ...
        <Card className="relative overflow-hidden card-3d">
          ...
          <CardContent className="relative z-10 p-4">
            <div className="flex items-center justify-between">
              <h3 className={`font-semibold ${settings.darkMode ? 'text-white' : 'text-purple-800'}`}> {getLocalizedText('time.period')} </h3>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Card className="relative overflow-hidden card-3d">
            ...
            <CardContent className="relative z-10 p-4 text-center">
              ...
              <p className={`text-sm ${settings.darkMode ? 'text-purple-300' : 'text-purple-600'}`}> {getLocalizedText('avg.cycle.length')}</p>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden card-3d">
            ...
            <CardContent className="relative z-10 p-4 text-center">
              ...
              <p className={`text-sm ${settings.darkMode ? 'text-pink-300' : 'text-pink-600'}`}> {getLocalizedText('avg.flow.days')} </p>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden card-3d">
            ...
            <CardContent className="relative z-10 p-4 text-center">
              ...
              <p className={`text-sm ${settings.darkMode ? 'text-amber-300' : 'text-amber-600'}`}> {getLocalizedText('total.symptoms')} </p>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden card-3d">
            ...
            <CardContent className="relative z-10 p-4 text-center">
              ...
              <p className={`text-sm ${settings.darkMode ? 'text-green-300' : 'text-green-600'}`}> {getLocalizedText('cycle.pattern')} </p>
            </CardContent>
          </Card>
        </div>
            ...
            <Card className="relative overflow-hidden card-3d">
              ...
              <CardHeader className="relative z-10">
                <CardTitle className={`flex items-center gap-2 ${settings.darkMode ? 'text-white' : 'text-purple-800'}`}>
                 ...
                 {getLocalizedText('cycle.length.trends')}
                </CardTitle>
              </CardHeader>
            ...
            <Card className="relative overflow-hidden card-3d mt-4">
              ...
              <CardHeader className="relative z-10">
                <CardTitle className={`flex items-center gap-2 ${settings.darkMode ? 'text-white' : 'text-pink-800'}`}>
                  ...
                  {getLocalizedText('flow.duration.analysis')}
                </CardTitle>
              </CardHeader>
            ...
            <Card className="relative overflow-hidden card-3d">
              ...
              <CardHeader className="relative z-10">
                <CardTitle className={`flex items-center gap-2 ${settings.darkMode ? 'text-white' : 'text-amber-800'}`}>
                  ...
                  {getLocalizedText('symptom.severity.trends')}
                </CardTitle>
              </CardHeader>
            ...
            <Card className="relative overflow-hidden card-3d mt-4">
              ...
              <CardHeader className="relative z-10">
                <CardTitle className={`flex items-center gap-2 ${settings.darkMode ? 'text-white' : 'text-orange-800'}`}>
                 ...
                 {getLocalizedText('flow.intensity.distribution')}
                </CardTitle>
              </CardHeader>
            ...
            <Card className="relative overflow-hidden card-3d">
              ...
              <CardHeader className="relative z-10">
                ...
                >
                  ...
                  {getLocalizedText('fertility.window.analysis')}
                </CardTitle>
              </CardHeader>
                ...
                >
                  ...
                  <CardContent className="relative z-10 p-4">
                    ...
                    <p className={`text-sm ${settings.darkMode ? 'text-gray-300' : 'text-green-600'}`}>
                      {phase.days} {getLocalizedText('days.avg')}
                    </p>
                    <Badge className="mt-2 bg-green-500">{phase.probability}% {getLocalizedText('fertility.chance')}</Badge>
                  </CardContent>
                </Card>
              ))}
            </div>
            ...
            <Card className="relative overflow-hidden card-3d">
              ...
              <CardHeader className="relative z-10">
                ...
                >
                 ...
                 {getLocalizedText('mood.and.energy.patterns')}
                </CardTitle>
              </CardHeader>
            ...
            <Card className={`relative overflow-hidden card-3d mt-4`}>
              ...
              <CardHeader className="relative z-10">
                <CardTitle className={`${settings.darkMode ? 'text-white' : 'text-purple-800'}`}>
                  {getLocalizedText('wellness.insights')}
                </CardTitle>
              </CardHeader>
              ...
              <CardContent className="relative z-10">
                <div className="space-y-3">
                  ...
                  >
                    <span className={`font-medium ${settings.darkMode ? 'text-white' : ''}`}>{getLocalizedText('best.energy.days')}</span>
                    <Badge className="bg-green-500">{getLocalizedText('day')} 7-14</Badge>
                  </div>
                  <div
                    className={`flex items-center justify-between p-3 rounded-lg ${settings.darkMode ? 'bg-slate-800 border border-slate-600' : 'bg-white'
                      }`}
                  >
                    <span className={`font-medium ${settings.darkMode ? 'text-white' : ''}`}>{getLocalizedText('mood.stability')}</span>
                    <Badge className="bg-blue-500">{getLocalizedText('good')}</Badge>
                  </div>
                  <div
                    className={`flex items-center justify-between p-3 rounded-lg ${settings.darkMode ? 'bg-slate-800 border border-slate-600' : 'bg-white'
                      }`}
                  >
                    <span className={`font-medium ${settings.darkMode ? 'text-white' : ''}`}>{getLocalizedText('sleep.quality')}</span>
                    <Badge className="bg-purple-500">{getLocalizedText('tracked.in.80.percent.cycles')}</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
  ...
  <CardContent className="relative z-10 p-6">
    <h3 className={`text-xl mb-4 ${settings.darkMode ? 'text-white' : 'text-black'}`}>
      📥 {getLocalizedText('export.your.data')}
    </h3>
    <p className={`${settings.darkMode ? 'text-gray-300' : 'text-purple-400'} mb-4`}>
     {getLocalizedText('download.cycle.data')}
    </p>
    <div className="flex gap-3">
      ...
      >
        {getLocalizedText('export.pdf.report')}
      </Button>
      <Button
        variant="outline"
        className={`border-white ${
      ...
      >
        {getLocalizedText('export.csv.data')}
      </Button>
    </div>
  </CardContent>
</Card>
