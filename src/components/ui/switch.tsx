...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      "peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-lavender-600 data-[state=unchecked]:bg-input",
      className
    )}
    {...props}
    ref={ref}
...
//     "data-[state=checked]:bg-lavender-600 data-[state=unchecked]:bg-transparent",
//     "data-[state=checked]:border-lavender-600 data-[state=unchecked]:border-gray-400",
//     className
//   )}
//   {...props}
//   ref={ref}
